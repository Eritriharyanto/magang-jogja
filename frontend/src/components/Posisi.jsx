        ...
        <div className="mt-10 grid gap-x-5 gap-y-8 sm:grid-cols-2 lg:grid-cols-4">
          {POSISI.map((p, i) => (
            <div key={i} className="flex flex-col items-center">
              ...
              <div className="mt-3 flex min-h-[3.5rem] w-full flex-col items-center justify-center rounded-lg bg-mj-green px-4 py-2 text-center leading-tight text-white">
